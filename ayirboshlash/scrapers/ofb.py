...
def scrape() -> list[dict]:
    ...
    with sync_playwright() as p:
        ...
        try:
            logger.info("Orient Finans Bank ochilmoqda...")
            ...
            # Format: "1 USD\n\nДоллар США\n\n\t\n\n11 980\n\n\t\n\n12 090"
            pattern = re.compile(
                r'\d+\s+(USD|EUR|RUB|GBP|CHF|JPY|KZT)'
                r'.+?\n\n\t\n\n'
                r'(\d[\d ]*)'
                r'\n\n\t\n\n'
                r'(\d[\d ]*)',
...
if __name__ == "__main__":
    ...
    rates = scrape()
    if rates:
        save_rates("ofb", rates)
        logger.success("Orient Finans Bank bazaga saqlandi!")
