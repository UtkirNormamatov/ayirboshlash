...
URL = "https://www.garantbank.uz/uz"
...
def scrape() -> list[dict]:
    ...
    with sync_playwright() as p:
        ...
        try:
            logger.info("Garant bank ochilmoqda...")
...
if __name__ == "__main__":
    ...
    rates = scrape()
    if rates:
        save_rates("garantbank", rates)
        logger.success("Garant bank bazaga saqlandi!")
